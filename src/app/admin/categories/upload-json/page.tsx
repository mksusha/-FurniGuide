...
export default function UploadCategoriesPage() {
    ...
    async function handleFileSubmit(e: FormEvent) {
        ...
        try {
            ...
            const res = await fetch('/api/admin/categories/upload-json', {
                method: 'POST',
            ...
            if (!res.ok) {
                ...
                setMessage(`Добавлено категорий: ${data.length}`);
            }
        } catch (err) {
    ...
    return (
        <div className="max-w-3xl mx-auto p-6 space-y-8">
            <h1 className="text-2xl font-bold mb-4 text-gray-900">Загрузка категорий из JSON</h1>
            ...
            <div className="space-y-3">
                ...
                <textarea
                    ...
                    placeholder="Вставьте JSON-массив категорий здесь"
                    value={jsonInput}
